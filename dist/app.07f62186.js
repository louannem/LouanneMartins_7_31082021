            ...
            for (var j = 0; j < _filters.filtersArray.length; j++) {
                ...
                if (_filters.filtersArray.length == 0 && _search.resultsArray.length > 0) {
                    (function () {
                        ...
                        (0, _addRecipes2.default)(filteredObjt);
                    ...
                    (0, _clearPage2.default)();(0, _addRecipes2.default)(_recipes.recipes);ifEmpty(_recipes.recipes);
                    ...
                    (0, _clearPage2.default)(filterAll);(0, _addRecipes2.default)(filterAll);ifEmpty(filterAll);
                } else if (_filters.filtersArray.length > 0 && _search.resultsArray.length == 0) {
                    var results = [];

                    var _loop2 = function _loop2(recipe) {
                        var filter = function filter(arr1) {
                        ...
                        if (filter(_filters.filtersArray)) {
                            results.push(recipe);
                            (0, _clearPage2.default)();(0, _addRecipes2.default)(results);ifEmpty(results);
                        }
                    };
...
},{"../data/recipes":24,"./filters":15,"./search":8,"../utils/addRecipes":26,"../utils/clearPage":27}],40:[function(require,module,exports) {
...
exports.ustensilsFilters = exports.applianceFilters = exports.ingredientFilters = exports.filtersArray = exports.tagList = undefined;
...
var tagList = exports.tagList = void 0,
    ...
    ingredientFilters = exports.ingredientFilters = [],
    applianceFilters = exports.applianceFilters = [],
    ustensilsFilters = exports.ustensilsFilters = [];
...
function filterFunction() {
    ...
    var _loop = function _loop(i) {
        var addTags = function addTags() {
            ...
            try {
                for (var _iterator2 = addedTags[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    if (!filtersArray.includes(tagName) && appareilsArray.includes(tagName)) {
                        filtersArray.push(tagName);applianceFilters.push(tagName);
                    }
                }
            ...
            try {
                for (var _iterator3 = ingredientFilters[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    var ingredient = _step3.value;
                    filter.ingredients.push({ ingredient: ingredient });
                }
            } catch (err) {
            ...
            try {
                for (var _iterator4 = ustensilsFilters[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    var ustensil = _step4.value;
                    filter.ustensils.push(ustensil);
                }
            } catch (err) {
            ...
            try {
                for (var _iterator5 = applianceFilters[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                    var appliances = _step5.value;
            ...
            if (filtersArray.length > 0 && _search.resultsArray.length > 0) {
                ...
                try {
                    for (var _iterator6 = _search.resultsArray[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                ...
                var _loop3 = function _loop3(_recipe) {
                    var filter = function filter(arr1) {
                        return arr1.every(function (elem) {
                            return _recipe.ingredients.some(function (ingredients) {
                                return ingredients.ingredient == elem;
                            }) || _recipe.ustensils.some(function (ustensils) {
                                return ustensils == elem;
                            }) || _recipe.appliance == elem;
                        });
                    };
                    if (filter(filtersArray)) {
                        results.push(_recipe);
                        (0, _clearPage2.default)();(0, _addRecipes2.default)(results);ifEmpty(results);
                    }
                };
                ...
                try {
                    for (var _iterator7 = _recipes.recipes[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                        var _recipe = _step7.value;
            ...
            (0, _removeTag2.default)(addedTags);
        };
...
},{"../data/recipes":24,"./search":8,"./clearPage":27,"./addRecipes":26,"./removeTag":41,"../assets/delete_icon.png":40}],26:[function(require,module,exports) {
"use strict";
...
},{"../components/Ingredient":36,"./filters":15}],8:[function(require,module,exports) {
"use strict";
    ...
    var globalSearch = function globalSearch() {
        ...
        if (searchInput.length > 2) {
            ...
            if (resultsArray.length > 0) {
                ...
                (0, _addRecipes2.default)(resultsArray);
            ...
            (0, _clearPage2.default)();(0, _addRecipes2.default)(_recipes.recipes);
            document.getElementById('no-result').style.display = "none";
...
},{"../data/recipes":24,"../utils/clearPage":27,"../utils/addRecipes":26}],7:[function(require,module,exports) {
"use strict";
...
init();
},{"./components/listExpand":18,"./utils/search":8}],19:[function(require,module,exports) {
...
//# sourceMappingURL=/app.07f62186.map